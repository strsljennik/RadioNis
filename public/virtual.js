...
const virtualGuests = [
    ...
    { nickname: 'Robot-X', messages: ['Bala, Hola, Halime -- ako se ne smirite brišacu vas sve 3 zauvek , razumele ?'], color: 'white' }, 
    ...
    { nickname: 'Robot-X', messages: [' Zovem se Robot-X, i ti, Holofiro, si ona kojoj srce dajem.'], color: 'white' },
    ...
    { nickname: 'Robot-X', messages: [' Gospodine, vi ste previše mladi za govor ljubavi, to je tek igra.'], color: 'white' },
    ...
    { nickname: 'Robot-X', messages: ['Nikad neću zaboraviti tvoje reči, -X, jer si sve za mene.'], color: 'white' },
